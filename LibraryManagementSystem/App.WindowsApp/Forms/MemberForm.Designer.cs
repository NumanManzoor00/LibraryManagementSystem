namespace App.WindowsApp.Forms
{
    partial class MemberForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            AddRow(labelId, "Member ID:", textBoxId, startY, labelX, inputX, labelW, inputW, rowH);
            ...
            AddRow(labelPhone, "Phone:", textBoxPhone, startY + gap * 3, labelX, inputX, labelW, inputW, rowH);

            buttonSave.Location = new Point(inputX, startY + gap * 4 + 10);
